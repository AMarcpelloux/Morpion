...
public class Test {
	...
	public static void main(String[] args) {
		try {
			...
			// LOAD DATA ...
			//
			HashMap<Integer, Coup> coups = loadGames("./res/dataset/Tic_tac_initial_results.csv");
			saveGames(coups, "./res/train_dev_test/", 0.7);
			//
			// LOAD CONFIG ...
			//
			...
			//
			double epochs = 10000 ;
			HashMap<Integer, Coup> mapTrain = loadCoupsFromFile("./res/train_dev_test/train.txt");
			...
			//PLAY ...
			//
			HashMap<Integer, Coup> mapDev = loadCoupsFromFile("./res/train_dev_test/dev.txt");
			...
			//
			HashMap<Integer, Coup> mapTest = loadCoupsFromFile("./res/train_dev_test/test.txt");
