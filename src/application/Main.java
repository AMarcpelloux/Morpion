...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			...
			// Scène principale
			BorderPane rootMain = (BorderPane) FXMLLoader.load(getClass().getResource("main.fxml"));
			...
			// Scène Settings
			VBox rootSettings = FXMLLoader.load(getClass().getResource("dif.fxml"));
			Scene sceneSettings = new Scene(rootSettings, WIN_WIDTH, WIN_HEIGHT);
			sceneSettings.getStylesheets().add(getClass().getResource("application.css").toExternalForm());
			
			// Scène Chargement
			HBox rootLoading = FXMLLoader.load(getClass().getResource("learn.fxml"));
			Scene sceneLoading = new Scene(rootLoading, WIN_WIDTH, WIN_HEIGHT);
			sceneLoading.getStylesheets().add(getClass().getResource("application.css").toExternalForm());
			
			// Scène Modèles
			Pane rootModels = (Pane) FXMLLoader.load(getClass().getResource("models.fxml"));
			Scene sceneModels = new Scene(rootModels, WIN_WIDTH, WIN_HEIGHT);
			sceneModels.getStylesheets().add(getClass().getResource("application.css").toExternalForm());
